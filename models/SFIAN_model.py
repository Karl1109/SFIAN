...
from .SFIAN_network import define_SFIAN, BinaryFocalLoss

class SFIANModel(BaseModel):
    @staticmethod
    ...
    def __init__(self, opt):
        ...
        # define networks 
        self.netG = define_SFIAN(opt.input_nc,
                                     opt.num_classes, 
                                     opt.ngf, 
                                     opt.norm,
                                     opt.init_type, 
        ...
        if self.isTrain:
            ...
            self.weight_side = [0.5, 0.75, 1, 0.75, 0.5]
